...
type App interface {
	...
	// ---------------------------------------------------------------
	// Page API event hooks
	// ---------------------------------------------------------------

	// OnPagesListRequest hook is triggered on each API Pages list request.
	//
	// Could be used to validate or modify the response before returning it to the client.
	OnPagesListRequest() *hook.Hook[*PagesListEvent]

	// OnPageViewRequest hook is triggered on each API Page view request.
	//
	// Could be used to validate or modify the response before returning it to the client.
	OnPageViewRequest() *hook.Hook[*PageViewEvent]

	// OnPageBeforeCreateRequest hook is triggered before each API
	// Page create request (after request data load and before model persistence).
	//
	// Could be used to additionally validate the request data or implement
	// completely different persistence behavior.
	OnPageBeforeCreateRequest() *hook.Hook[*PageCreateEvent]

	// OnPageAfterCreateRequest hook is triggered after each
	// successful API Page create request.
	OnPageAfterCreateRequest() *hook.Hook[*PageCreateEvent]

	// OnPageBeforeUpdateRequest hook is triggered before each API
	// Page update request (after request data load and before model persistence).
	//
	// Could be used to additionally validate the request data or implement
	// completely different persistence behavior.
	OnPageBeforeUpdateRequest() *hook.Hook[*PageUpdateEvent]

	// OnPageAfterUpdateRequest hook is triggered after each
	// successful API Page update request.
	OnPageAfterUpdateRequest() *hook.Hook[*PageUpdateEvent]

	// OnPageBeforeDeleteRequest hook is triggered before each API
	// Page delete request (after model load and before actual deletion).
	//
	// Could be used to additionally validate the request data or implement
	// completely different delete behavior.
	OnPageBeforeDeleteRequest() *hook.Hook[*PageDeleteEvent]

	// OnPageAfterDeleteRequest hook is triggered after each
	// successful API Page delete request.
	OnPageAfterDeleteRequest() *hook.Hook[*PageDeleteEvent]
